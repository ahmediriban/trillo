    ...
    return(
        <header className="header">
            ...
            <form action="#" className="search">
                <input type="text" placeholder="Search hotel" className="search__input"/>

                <button className="search__button">
                    {
                        <svg version="1.1" className="search__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <nav className="user-nav">
                <div className="user-nav__icon-box">
                    {
                        <svg version="1.1" className="user-nav__icon" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 20 20">
                ...
                <div className="user-nav__user">
                    ...
                    <span className="user-nav__user-photo">Jonas</span>
                </div>
            </nav>
        </header>
    );
